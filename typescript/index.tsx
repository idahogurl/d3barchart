...
class BarChart extends Component<any,any> {
    ...
    constructor()
    {
        ...
        this.margin = new Margin(30, 30, 40, 50);
        this.height = 400 - this.margin.top - this.margin.bottom;
        this.width = 600 - this.margin.left - this.margin.right;
        
        this.axisLabel = "Gross Domestic Product, USA";
        this.title = "Gross Domestic Product";
    ...
    {   
        ...
        let years = this.barData.map(m => { return m[0].getFullYear(); });
        let maxYear = D3.max(years);
        let minYear = D3.min(years);
        let xScale = D3.scaleBand()
            .domain(D3.range(minYear, maxYear).map(m => { return m.toString()}))
    ...
    addHorizontalAxis()
    {
        ...
        let hAxis = D3.axisBottom(this.xScale)
            .tickValues(this.xScale.domain()
                .filter((d,i) => {
                    return !(i % (this.barData.length / 10));
                }));
   
        let hGuide = D3.select("svg").append("g").call(hAxis);
    ...
    addVerticalAxis()
    {
        ...
        let vGuide = D3.select("svg").append("g").call(vAxis);
